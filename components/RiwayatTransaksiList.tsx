...
/** List riwayat transaksi milik user — dipakai di tab Riwayat Transaksi halaman /notifikasi */
export default function RiwayatTransaksiList({ transaksis }: { transaksis: RiwayatTransaksiItem[] }) {
